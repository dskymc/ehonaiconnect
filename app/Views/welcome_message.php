...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo">
                <a href="<?= base_url('/') ?>" title="e-Honai Connect">
                    <img src="<?= base_url('assets/images/logo-papua-pegunungan.png') ?>" alt="Lambang Provinsi Papua Pegunungan" class="header-logo-img" height="44" decoding="async">
                </a>
            </li>
